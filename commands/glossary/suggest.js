...
module.exports = {
    name: `suggest`,
    alias: ['sg'],
    description: `Suggests info for bot-faq and audition function. Depreceated.`,
	...
	async execute(message, args) {
        ...
        return message.channel.send("This is a depreceated method. If you want to add entries, please fill in directly from the template instead. Say \"Kaori, source template\" to get the template and instructions ")
        ...
        // async function storeFaqData(initiator, data, minEntry) {
            
        //     var buffer = ExcelUtility.storeFaqData(initiator, message.author.tag, data[0], data[1], data.splice(0, minEntry))
