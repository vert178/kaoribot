...
% \subsection{Cooldown}
% \textbf{Type: integer} \hspace{5pt} The amount of time (in seconds) between each command.

% \subsection{MinArgs}
% \textbf{Type: integer} \hspace{5pt} The minimum number of arguments required for command execution.
...
% \subsection{Events}
% An event is something triggered by Discord API itself, which represents passive events, such as someone joining the server, someone sending a message etc.

% \subsubsection{Name}
% \textbf{Type: string} \hspace{5pt} The initiator of the event. Usually something more descriptive and you can search it up on Discord JS documentation.

% \subsubsection{Once}
% \textbf{Type: boolean} \hspace{5pt} Whether the command should only be executed once.

% \subsubsection{Execute}
% \textbf{Type: function(args, client)} \hspace{5pt} The body of the event to be executed the event is triggered.
